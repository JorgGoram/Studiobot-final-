        ...
        <div className="bg-zinc-900/80 backdrop-blur-sm rounded-xl p-6 border border-zinc-800/80">
          ...
          <div className="mb-8">
            ...
            <input
              ...
              max="30"
              step="1"
              value={formData.pauseBeforeSpeaking}
              onChange={(e) =>
              ...
              style={{
                background: `linear-gradient(to right, #904AF2 ${
                  ((formData.pauseBeforeSpeaking || 0) / 30) * 100
                }%, #27272a ${
                  ((formData.pauseBeforeSpeaking || 0) / 30) * 100
                }%)`,
              }}
            ...
            <div className="text-right text-sm mt-1">
              {formData.pauseBeforeSpeaking || 0}s
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <input
              ...
              style={{
                background: `linear-gradient(to right, #904AF2 ${
                  ((formData.ringDuration || 0) / 30) * 100
                }%, #27272a ${((formData.ringDuration || 0) / 30) * 100}%)`,
              }}
            />
            <div className="text-right text-sm mt-1">
              {formData.ringDuration || 0}s
            </div>
          </div>
              ...
              <>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    max="15"
                    step="1"
                    value={formData.idleReminderTime || 0}
                    onChange={(e) =>
                    ...
                    style={{
                      background: `linear-gradient(to right, #904AF2 ${
                        ((formData.idleReminderTime || 0) / 15) * 100
                      }%, #27272a ${
                        ((formData.idleReminderTime || 0) / 15) * 100
                      }%)`,
                    }}
                  />
                  <div className="text-right text-sm mt-1">
                    {formData.idleReminderTime || 0} minutes
                  </div>
                </div>
