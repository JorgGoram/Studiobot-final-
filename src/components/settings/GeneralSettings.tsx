  ...
  return (
    <div className="w-full flex justify-center">
      <div className="w-full max-w-3xl space-y-8">
        ...
        <div className="bg-zinc-900/80 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-zinc-800/80">
          <h2 className="text-xl font-semibold mb-4 sm:mb-6 flex items-center justify-center">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              {operatingHours.map((hours, index) => (
                <div
                  key={hours.day}
                  className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 p-3 rounded-lg bg-black/20"
                >
                  <div className="flex justify-between sm:w-28 items-center">
                    ...
                    <div className="sm:hidden">
                      <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        />
                        <div className="w-9 h-5 bg-zinc-700 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-purple-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-purple-600"></div>
                      </label>
                    </div>
                  </div>
                  ...
                  {hours.isOpen && (
                    <div className="flex items-center space-x-2 flex-1">
                      <input
                        ...
                        className="w-full bg-black/30 border border-zinc-800 rounded-lg px-2 sm:px-3 py-1 focus:outline-none focus:ring-2 focus:ring-purple-600 text-sm"
                      />
